...
teams_div_1 <- c("Fighting+Shockwaves","Majestics","War+Angels","Warriors","Surge","Titans",
...
#saveRDS(table_data,"div_all_stats.rds")
...
#saveRDS(week_results_table,"game_score_historical.rds")
