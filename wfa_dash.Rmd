...
_This tool and all analytics completed are at the mercy of reporting. Not all teams report every game and not all stats for players are reported (e.g. a running back has one carry, but 150 yards). Also, the accuracy of statistics reported are at the teams' discretion, particularly for defensive statistics. Ideally, a player ranking system at each position would be created; however, on the defensive side of the ball determining a player's position based entirely on the statistics provided is nearly impossible._
